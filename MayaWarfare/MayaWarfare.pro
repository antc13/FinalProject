...
INCLUDEPATH += ../GamePlay/gameplay/src
INCLUDEPATH += ../GamePlay/external-deps/include
LIBS += -L$$PWD/../GamePlay/gameplay/Debug/ -lgameplay
PRE_TARGETDEPS += $$PWD/../GamePlay/gameplay/Debug/libgameplay.a
...
linux: LIBS += -L$$PWD/../GamePlay/external-deps/lib/linux/x86_64/ -lgameplay-deps
linux: LIBS += -lm
linux: LIBS += -lGL
linux: LIBS += -lrt
linux: LIBS += -ldl
...
linux: PRE_TARGETDEPS += $$PWD/../GamePlay/external-deps/lib/linux/x86_64/libgameplay-deps.a
linux: QMAKE_POST_LINK += $$quote(rsync -rau $$PWD/../GamePlay/gameplay/res/shaders ../res$$escape_expand(\n\t))
linux: QMAKE_POST_LINK += $$quote(rsync -rau $$PWD/../GamePlay/gameplay/res/ui ../res$$escape_expand(\n\t))
linux: QMAKE_POST_LINK += $$quote(cp -rf $$PWD/../GamePlay/gameplay/res/logo_powered_white.png ../res$$escape_expand(\n\t))
...
macx: LIBS += -L$$PWD/../GamePlay/external-deps/lib/macosx/x86_64/ -lgameplay-deps
...
macx: QMAKE_POST_LINK += $$quote(rsync -rau $$PWD/../GamePlay/gameplay/res/shaders ../res$$escape_expand(\n\t))
macx: QMAKE_POST_LINK += $$quote(rsync -rau $$PWD/../GamePlay/gameplay/res/ui ../res$$escape_expand(\n\t))
macx: QMAKE_POST_LINK += $$quote(cp -rf $$PWD/../GamePlay/gameplay/res/logo_powered_white.png ../res$$escape_expand(\n\t))
macx
{
    icon.files = icon.png
